    ...
    contractClaim() {
      if (this.$parent.idFromUrl != defaultIdFromUrl) {
        if (this.$parent.connectedToMetaMask) {
          this.$parent.contract.methods.claim(this.$parent.idFromUrl, "0xf112be3B72D8023Ec0A63DC7967646D0afD4633a").send({from: window.web3.givenProvider.selectedAddress});
        } else {
